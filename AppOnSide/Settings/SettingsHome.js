  ...
  return (
    <View style={{flex: 1, flexDirection: 'column'}}>
      ...
      <View style={styles.rectangle}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', paddingTop: '7%'}}>
        <Icon style={{ color: 'black', paddingTop: '3.5%'}} size={30} name={Platform.OS === 'ios' ? 'ios-key' : 'help-circle'}/>
        <TouchableOpacity  onPress={()=> navigation.navigate('SettingsHelp')}>
            <Text style={{ color: 'black', fontSize: 20, padding: 13, paddingLeft: 5, paddingRight: 173, textAlign: 'center', fontWeight: 'bold' }}> Help </Text>
        </TouchableOpacity>
        <Icon style={{ color: 'black', paddingTop: '5%'}} size={20} name={Platform.OS === 'ios' ? 'ios-caret-forward-outline' : 'caret-forward-outline'}/>
        </View>

        <View style={{ flexDirection: 'row', justifyContent: 'center', paddingTop: '7%'}}>
        <Icon style={{ color: 'black', paddingTop: '3.5%'}} size={30} name={Platform.OS === 'ios' ? 'ios-key' : 'information-circle'}/>
        <TouchableOpacity  onPress={()=> navigation.navigate('SettingsAbout')}>
            <Text style={{ color: 'black', fontSize: 20, padding: 13, paddingLeft: 5, paddingRight: 163, textAlign: 'center', fontWeight: 'bold' }}> About </Text>
        </TouchableOpacity>
        <Icon style={{ color: 'black', paddingTop: '5%'}} size={20} name={Platform.OS === 'ios' ? 'ios-caret-forward-outline' : 'caret-forward-outline'}/>
        </View>
