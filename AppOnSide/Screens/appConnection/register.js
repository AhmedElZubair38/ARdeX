...
const insertUser2 = async (name,email,username) => {
    const response = await fetch('http://192.168.137.25:3000/api/insertUser2' , {
        method: 'POST',
        headers: {
...
const checkUsername = async (username) => {
    const response = await fetch('http://192.168.137.25:3000/api/checkUsername/' + username , {
        method: 'GET',
        headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
        ...
        const getUserIdFromEmail = async (email) => {
            const response = await fetch('http://192.168.137.25:3000/api/getUserIdFromEmail/' + email , {
                method: 'GET',
                headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
